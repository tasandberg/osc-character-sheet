// GM "apply damage" wiring for osc-sheet damage cards.
//
 ...
 *  ids, so we read/write our osc-sheet flags through a loose surface. */
interface FlagMsg {
...
export function onRenderChatMessage(message: ChatMessage, html: HTMLElement): void {
  // Only touch our own cards — gate on the osc-sheet flag / the card marker.
  const isOurs =
