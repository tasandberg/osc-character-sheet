...
const encumbrance: EncumbranceVM = { enabled: true, value: 380, max: 1600, pct: 0.2375, tier: 0, status: "Unencumbered", label: "380 / 1600 cn", move: 120, moveBands: { encounter: 40, explore: 120, travel: 24 } };
const coins = [
