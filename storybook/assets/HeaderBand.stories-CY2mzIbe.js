import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./iframe-1-UdovT7.js";import{n as i,t as a}from"./Stamp-DODP-Q9R.js";import{n as o,t as s}from"./useHpInput-B_MKU7E5.js";import{c,l,n as u,o as d,r as f}from"./MovePop-L8_plyhr.js";function p(e,t=.6){let n=(0,h.useRef)(null);return(0,h.useLayoutEffect)(()=>{let e=n.current;if(!e)return;let r=()=>{e.style.setProperty(`--fit-scale`,`1`);let n=e.clientWidth,r=e.scrollWidth,i=r>n&&r>0?Math.max(t,n/r):1;e.style.setProperty(`--fit-scale`,String(i))};r();let i=new ResizeObserver(r);return i.observe(e),()=>i.disconnect()},[e,t]),n}function m({identity:e,vitals:t,encumbrance:n,onSetHp:r,onPortraitContextMenu:i,canEditPortrait:s}){let l=t.moveBands,f=p(e.name),m=o({value:t.hp.value,max:t.hp.max,onSet:r??(()=>{})});return(0,g.jsxs)(`div`,{className:`osc-head`,children:[(0,g.jsx)(`div`,{className:`osc-portrait-wrap profile`,children:(0,g.jsx)(`img`,{className:`osc-portrait profile-img`,src:e.img||void 0,alt:e.name,"data-action":s?`editImage`:void 0,"data-edit":`img`,title:e.name,onContextMenu:i})}),(0,g.jsxs)(`div`,{className:`osc-ident`,children:[(0,g.jsx)(`div`,{className:`osc-name`,ref:f,children:e.name}),(0,g.jsxs)(`div`,{className:`osc-class`,children:[e.classLabel,` `,e.level,e.title?` · ${e.title}`:``,` · `,e.alignment]})]}),(0,g.jsxs)(`div`,{className:`osc-substats`,children:[(0,g.jsxs)(`div`,{className:`osc-tile`,children:[(0,g.jsx)(a,{children:`INIT`}),(0,g.jsx)(`div`,{className:`osc-tile-v`,children:c(t.initMod)})]}),(0,g.jsxs)(`div`,{className:`osc-tile`,children:[(0,g.jsx)(a,{children:`HD`}),(0,g.jsx)(`div`,{className:`osc-tile-v`,children:t.hd})]}),(0,g.jsxs)(`div`,{className:`osc-tile osc-tile-move`,children:[(0,g.jsx)(a,{children:`MOVE`}),(0,g.jsxs)(`div`,{className:`osc-tile-v`,children:[t.move,`ft`]}),(0,g.jsx)(u,{bands:l,tier:n?.enabled?n.tier:void 0,status:n?.enabled?n.status:void 0,armor:n?.enabled&&n.armorTier?d(n.armorTier):void 0})]})]}),(0,g.jsxs)(`div`,{className:`osc-vitals`,children:[(0,g.jsxs)(`div`,{className:`osc-vital hp`,children:[(0,g.jsx)(a,{className:`vv-l`,children:`HP`}),(0,g.jsxs)(`div`,{className:`vv-row`,children:[r&&(0,g.jsx)(`button`,{type:`button`,className:`vv-step`,"aria-label":`Lose 1 HP`,onClick:m.dec,children:`−`}),(0,g.jsx)(`div`,{className:`vv-big vv-value`,children:t.hp.value}),r&&(0,g.jsx)(`input`,{className:`vv-big vv-input`,"aria-label":`Current HP`,...m.inputProps},m.key),r&&(0,g.jsx)(`button`,{type:`button`,className:`vv-step`,"aria-label":`Heal 1 HP`,onClick:m.inc,children:`+`})]}),(0,g.jsxs)(`div`,{className:`vv-sub`,children:[(0,g.jsxs)(`span`,{className:`full`,children:[`Max `,t.hp.max]}),(0,g.jsxs)(`span`,{className:`short`,children:[`/`,t.hp.max]})]})]}),(0,g.jsxs)(`div`,{className:`osc-vital ac`,children:[(0,g.jsx)(a,{className:`vv-l`,children:`AC`}),(0,g.jsx)(`div`,{className:`vv-row`,children:(0,g.jsx)(`div`,{className:`vv-big`,"data-testid":`ac-value`,children:t.ac.value})}),(0,g.jsxs)(`div`,{className:`vv-sub`,children:[(0,g.jsx)(`span`,{className:`full`,children:t.ac.ascending?`Ascending`:`Descending`}),(0,g.jsx)(`span`,{className:`short`,children:t.ac.ascending?`asc`:`desc`})]})]})]})]})}var h,g,_=e((()=>{h=t(n(),1),l(),i(),f(),s(),g=r(),m.__docgenInfo={description:`Header band. Grid areas (see actions.scss) place: portrait · name+Init/HD/Move
